...
export class HotelsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.hotelService.getHotels().subscribe(res => {
      this.hotels = this.dataProcessingService.createArrayOfHotelsByAdminId(
        res
      );
      this.canAddMoreProperty =
        this.dataStorageService.getUser().number > this.hotels.length;
    });
  ...
  openNewHotel(contentNewHotel) {
    ...
    this.addNewHotelModal.result.then(
      result => {
  ...
  goToNotifications(hotel) {
    this.dataStorageService.setHotelId(hotel.id);
    this.dataStorageService.setHotelName(hotel.data.name);
